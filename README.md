...
# Chạy products.json trong db bằng lệnh json-server --watch products.json --port 4000(đây là dữ liệu từ json,không phải gán cứng)
=======
...
- [Chạy products.json trong db bằng lệnh json-server --watch products.json --port 4000(đây là dữ liệu từ json,không phải gán cứng)](#chạy-productsjson-trong-db-bằng-lệnh-json-server---watch-productsjson---port-4000đây-là-dữ-liệu-từ-jsonkhông-phải-gán-cứng)
